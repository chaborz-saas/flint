const CACHE = 'flint-v290';
const ASSETS = ['./', './index.html', './manifest.webmanifest', './logo.png', './icon-192.png', './icon-512.png', './apple-touch-icon.png', './favicon-32.png', './bg-home.png', './recup-body.png', './recup-empty.png?v=3', './steps-empty.png?v=2', './steps-hero.png?v=1', './balance-hero.png?v=4', './fc-art.png?v=1'];
